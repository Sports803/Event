    ...
    return SafeArea(
      child: RefreshIndicator(
        ...
        child: CustomScrollView(slivers: [
          ...
          SliverToBoxAdapter(child: Padding(padding: const EdgeInsets.fromLTRB(20, 22, 20, 15), child: Row(children: [Text('Live & upcoming', style: GoogleFonts.poppins(fontSize: 27, fontWeight: FontWeight.w700)), const SizedBox(width: 10), Container(padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 5), decoration: BoxDecoration(color: accent.withOpacity(.15), borderRadius: BorderRadius.circular(20)), child: Text('${filtered.length}', style: const TextStyle(color: accent, fontWeight: FontWeight.bold)))]))),
